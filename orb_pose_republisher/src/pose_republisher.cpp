...
void PoseRepublisher::save()
{
	if (init_true && init_ar)
	{
		...
		double roll_orb,pitch_orb,yaw_orb;
		GetRPY(orb_topic.pose.orientation, roll_orb,pitch_orb,yaw_orb);
		orb_o << count <<","<< orb_topic.pose.position.x <<","<< orb_topic.pose.position.y <<","<< orb_topic.pose.position.z <<","<< orb_topic.pose.orientation.x <<","<< orb_topic.pose.orientation.y <<","<< orb_topic.pose.orientation.z <<","<< orb_topic.pose.orientation.w<<","<< roll_orb <<","<< pitch_orb <<","<< yaw_orb<<std::endl;
    }
}
